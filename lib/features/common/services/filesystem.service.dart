...
import 'package:flash_cards_1/features/common/components/generic/generic_confirmation.dart';
import 'package:flash_cards_1/features/common/components/generic/generic_prompt.dart';
import 'package:flutter/material.dart';
import 'package:riverpod_annotation/riverpod_annotation.dart';
import 'package:intl/intl.dart';

part 'filesystem.service.g.dart';
    ...
    await showModalBottomSheet(
      ...
      builder: (context) {
        if (defaultName == null) {
          ...
          defaultName = 'predictions-$datePart';
        }
        return Padding(
    ...
    await showModalBottomSheet(
      ...
      builder: (context) {
        return GenericConfirmation(
          ...
          message: 'Replace current predictions? Unsaved data will be lost.',
          onConfirm: () {
            result = true;
            Navigator.of(context).pop();
          },
